...
[![Tests](https://img.shields.io/badge/Tests-17%20Exam%20Sets-blue)]()
[![Questions](https://img.shields.io/badge/Questions-1%2C675-green)]()

**17 HSK 4 mock and official exam sets** with listening, reading, and writing sections — structured JSON data, ready to use in your app, flashcard tool, or study workflow.

17 套 HSK 4 模拟/官方试题，涵盖听力、阅读、书写三大部分，JSON 格式，可直接用于 App 开发、刷题工具或学习系统。
